...
urlpatterns = [
    ...
    url('Products_by_category/', views.Products_by_category, name="Products_by_category"),
    ...
    url(r'^comparison/(?P<product_id>[0-9]+)/$', views.compare_price, name='compare_price'),
    url(r'^store/(?P<store_id>[0-9]+)/$', views.open_store, name='open_store'),
