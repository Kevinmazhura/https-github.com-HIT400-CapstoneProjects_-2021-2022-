...
class Category(models.Model):
    ...
    image = models.ImageField(upload_to='category/',null=True, blank=True,default=Image_default)
    online_image = models.CharField(max_length=1000, blank=True)
    online_link = models.CharField(max_length=1000, blank=True)
...
class Product(models.Model):
    ...
    image = models.ImageField(upload_to='products/%Y/%m/%d', blank=True,default=Image_default)
